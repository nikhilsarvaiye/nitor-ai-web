...
import { DeleteFilled, DeleteOutlined, DownCircleOutlined, PlusOutlined } from '@ant-design/icons';
...
const _BaseList = (props: BaseListAdditionalProps) => {
    ...
    const onDelete = () => {
        props.store.confirmDeleteMultiple(props.store.selectedItems.map((x) => x.id));
    };
